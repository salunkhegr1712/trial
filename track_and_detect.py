...
def draw_boxes(img, bbox, names,object_id, identities=None, offset=(0, 0)):
    ...
    # return img
        ...
        for idx, (key, value) in enumerate(object_counter1.items()):
            ...
            cv2.putText(img, f'Number of vehicles leaving', (11, 35), 0, 1, [225, 255, 255], thickness = 2, lineType = cv2.LINE_AA)
            cv2.line(img, (20, 65+(idx*40)), (27, 65+(idx*40)), [85,45,255], 30)
            cv2.putText(img, cnt_str, (11, 75+(idx*40)), 0, 1, [225, 255, 255], thickness = 2, lineType = cv2.LINE_AA) 
